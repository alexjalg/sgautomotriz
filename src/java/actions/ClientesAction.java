            ...
            try {
                ...
                if (!indError.equals("")) {
                    ...
                    if (indError.equals("")) {
                        ...
                        indError = objmy.executeNonQuery("call usp_insCliente(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[]{cliente.getIdCli(),
                            cliente.getIdTipDoc(),
        ...
        if (indErrAcc.equals("")) {
            ...
            try {
                ...
                if (!indError.equals("")) {
                    ...
                    validaform();
                    if (indError.equals("")) {
                        indError = objmy.executeNonQuery("call usp_updCliente(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[]{cliente.getIdCli(),
                            cliente.getDesCli(),
                            cliente.getDesApeCon(),
                            cliente.getDesNomCon(),
                            cliente.getDesDirCon(),
