    ...
    <form id="frm_princ" method="POST" action="<s:property value="baseURL" /><s:property value="urlPaginacion" />">
        ...
        <div class="d-grilla" style="overflow: hidden;">
            ...
            <div class="d-content-grilla-body">
                <table border="0" cellpadding="0" cellspacing="0" style="">
                    <s:iterator value="listTipDoc">
                        <tr>
                            <td style="width: 24px;">
                                <input type="radio" name="idTipDoc" id="rbt_idTipDoc" value="<s:property value="idTipDoc" />" class="select_rec" />
                            </td>
                            <td style="width:60px; text-align: center;">
                                <s:property value="idTipDoc" />
                            </td>                            
                            <!--<td style="width:90px; text-align: center;">!-->
                            <td style="">
                                <s:property value="desTipDoc" />
                            </td>
                            <td style="width:90px; text-align: center;">
                                <s:property value="otrTipCli" />
                            </td>
                            <td style="width:70px; text-align: center;">
                                <s:property value="numLonVal" />
                            </td>
                        </tr>
                    </s:iterator>
                </table>
...
<script type="text/javascript">
    ...
    <s:property value="jsPaginacion" escape="false" />
        ...
        $('#btn-add').click(function() {
            ...
            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="tipoDocumento" includeContext="false" action="adicionarTipoDocumento" />');
            $('#frm_princ').submit();
        });

        $('#btn-edit').click(function() {
            post(
                    '<s:property value="baseURL" /><s:url namespace="tipoDocumento" includeContext="false" action="vrfSeleccionTipoDocumento" />',
                    $('#frm_princ').serialize(),
                    function(resultado) {
                        ...
                        else
                        {
                            ...
                            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="tipoDocumento" includeContext="false" action="modificarTipoDocumento" />');
                            $('#frm_princ').submit();
                        }
                    },
                    1
            ...
            post(
                    ...
                    function(resultado) {
                        ...
                        else
                        {
                            $('#opcion_h1').val('C');
                            post(
                                    '<s:property value="baseURL" /><s:url namespace="tipoDocumento" includeContext="false" action="eliminarTipoDocumento" />',
                                    $('#frm_princ').serialize(),
                                    function(resultado1)
                                    {
                                                    ...
                                                    "Confirmar": function() {
                                                        ...
                                                        post(
                                                                ...
                                                                function(resultado2)
                                                                {
                                                                    ...
                                                                    {
                                                                        $('#DIVeliminar').dialog('close');
                                                                        $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="tipoDocumento" includeContext="false" action="TipoDocumento" />');
                                                                        $('#frm_princ').submit();
                                                                    }
                                                                },
                                                                4
