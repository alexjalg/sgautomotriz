...
<form method="POST" id="frm_tipodocumento_back" action="<s:property value="backURL" />">
    <!--s:hidden name="varReturn" id="varReturn_f" />!-->
    <s:property value="datosOblig" escape="false" />
</form>

<div class="d-content-form">
    <s:form id="frm_tipodocumento" action='javascript:void(0)' theme="simple">
        <s:hidden name="idTipDoc" />
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 110px;">Documento<span class="required">*</span></td>
                <td>
                    <s:textfield name="desTipDoc" cssClass="element-form" cssStyle="width:350px;" maxLength="40" />
                </td>
            </tr>
            <tr>
                <td style="width: 110px;">Tipo de Cliente<span class="required">*</span></td>
                <td>
                    <s:select name="otrTipCli" list="#{'N':'Natural', 'J':'Jurídica'}" headerKey="" 
                              headerValue="-Seleccione-" cssClass="element-form" cssStyle="width: 120px;" />
                </td>
            </tr>
            <tr>
                <td style="width: 110px;">Validación<span class="required">*</span></td>
                <td>
                    <s:textfield name="numLonVal" cssClass="element-form" cssStyle="width:40px;" maxLength="2" onkeypress="return isNumberKey(event)"/>
                </td>
            </tr>
            <tr>
                <td></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('a.back').click(function() {
            $('#frm_tipodocumento_back').submit();
        });

        $('#btn_grabar').click(function() {
            post(
                    '<s:property value="formURL" />',
                    $('#frm_tipodocumento').serialize(),
                    function(resultado) {
