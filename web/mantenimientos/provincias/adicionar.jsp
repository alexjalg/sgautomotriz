...
<div class="d-header">
    ...
    <div class="d-subheader">
        <div class="d-back">
            ...
            <form method="POST" id="frm_provincia_back" action="<s:property value="backURL" />">
...
<div class="d-content-form">
    <s:form id="frm_provincia" action='javascript:void(0)' theme="simple">
        <s:hidden name="idDep" />
        <s:hidden name="idPrvDep" />
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 90px;">Provincia<span class="required">*</span></td>
                <td>
                    <s:textfield name="desProv" cssClass="element-form" cssStyle="width:350px;" maxLength="40" />
                </td>
            </tr>
            <tr>
                <td></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('a.back').click(function(){
            $('#frm_provincia_back').submit();
        });
        
        $('#btn_grabar').click(function(){
            post(
                '<s:property value="formURL" />',
                $('#frm_provincia').serialize(),
                function(resultado){
