    ...
    <form id="frm_princ" method="POST" action="<s:property value="baseURL" /><s:property value="urlPaginacion" />">
        ...
        <div class="d-grilla" style="overflow: hidden;">
            ...
            <div class="d-content-grilla-body">
                <table border="0" cellpadding="0" cellspacing="0" style="">
                    <s:iterator value="listModVen">
                        <tr>
                            <td style="width: 24px;">
                                <input type="radio" name="idModVen" id="rbt_idModVen" value="<s:property value="idModVen" />" class="select_rec" />
                            </td>
                            <td style="width:60px; text-align: center;">
                                <s:property value="idModVen" />
                            </td>
                            <td style="">
...
<script type="text/javascript">
    ...
    <s:property value="jsPaginacion" escape="false" />
        ...
        $('#btn-add').click(function() {
            ...
            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="modalidadVenta" includeContext="false" action="adicionarModalidadVenta" />');
            $('#frm_princ').submit();
        });

        $('#btn-edit').click(function() {
            post(
                    '<s:property value="baseURL" /><s:url namespace="modalidadVenta" includeContext="false" action="vrfSeleccionModalidadVenta" />',
                    $('#frm_princ').serialize(),
                    function(resultado) {
                        ...
                        else
                        {
                            ...
                            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="modalidadVenta" includeContext="false" action="modificarModalidadVenta" />');
                            $('#frm_princ').submit();
                        }
                    },
                    1
            ...
            post(
                    ...
                    function(resultado) {
                        ...
                        else
                        {
                            $('#opcion_h1').val('C');
                            post(
                                    '<s:property value="baseURL" /><s:url namespace="modalidadVenta" includeContext="false" action="eliminarModalidadVenta" />',
                                    $('#frm_princ').serialize(),
                                    function(resultado1)
                                    {
                                                    ...
                                                    "Confirmar": function() {
                                                        ...
                                                        post(
                                                                ...
                                                                function(resultado2)
                                                                {
                                                                    ...
                                                                    {
                                                                        $('#DIVeliminar').dialog('close');
                                                                        $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="modalidadVenta" includeContext="false" action="ModalidadVenta" />');
                                                                        $('#frm_princ').submit();
                                                                    }
                                                                },
                                                                4
