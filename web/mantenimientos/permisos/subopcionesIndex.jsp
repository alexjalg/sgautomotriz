    ...
    <div class="d-header-labels">
        <table>
            <tr>
                ...
                <td class="lbl-concept">Opción: </td>
                <td class="lbl-value"><span><s:property value="desOpc1" /><span></td>
            </tr>
        </table>
    </div>
</div>
    ...
    <div class="d-grilla" style="overflow: hidden;">
        ...
        <div class="d-content-grilla-body">
            <table border="0" cellpadding="0" cellspacing="0" style="">
                ...
                <tr>
                    <td style="width: 24px;">
                        <input type="radio" name="idOpc2" id="rbt_idOpc2" value="<s:property value="idOpc" />" class="select_rec" />
                    </td>
                    <td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {   
        ...
        $('#btn-add').click(function(){    
            ...
            var _varret = $('#nivBandeja_f').val()+'%'+href+'%'+$('#mtu_h1').val()+'%'+$('#mmo_h1').val()+'%'+$('#mop_h1').val()+'%'+$('#mni_h1').val()+'%'+$('#mod_h1').val()+'%'+$('#curPag_f').val()+'%'+$('#idTipUsu_h1').val()+"%"+$('#idModu_h1').val()+"%"+$('#idOpc1_h1').val()+'|';
            $('#varReturn_f').val($('#varReturn_f').val()+_varret);
            
            $('#frm_princ').attr('action','<s:property value="baseURL" /><s:url namespace="permisos" includeContext="false" action="adicionarSubOpcionPermisos" />');
            $('#frm_princ').submit();
        });
        
        $('#btn-edit').click(function(){    
            post(
                '<s:property value="baseURL" /><s:url namespace="permisos" includeContext="false" action="vrfSelecSubOpcionPermisos" />',
                $('#frm_princ').serialize(),
                function(resultado){
            ...
            post(
                ...
                function(resultado){
                    ...
                    else
                    {
                        $('#opcion_h1').val('C');
                        post(
                            '<s:property value="baseURL" /><s:url namespace="permisos" includeContext="false" action="eliminarSubOpcionPermisos" />',
                            $('#frm_princ').serialize(),
                            function(resultado1)
                            {
