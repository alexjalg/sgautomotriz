...
<div class="d-header">
    ...
    <div class="d-subheader">
        <div class="d-back">
            ...
            <form method="POST" id="frm_permisosSubOpcion_back" action="<s:property value="backURL" />">
...
<div class="d-content-form">
    <s:form id="frm_permisosSubOpcion" action='javascript:void(0)' theme="simple">
        <s:hidden name="idTipUsu" />
        <s:hidden name="idModu" />
        <s:hidden name="idOpc1" />
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 101px;">Opción<span class="required">*</span></td>
                <td>
                    <s:hidden name="idOpc2" id="opcionIdOpc" />
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('a.back').click(function(){
            $('#frm_permisosSubOpcion_back').submit();
        });
        ...
        $('#btn_grabar').click(function(){
            post(
                ...
                $('#frm_permisosSubOpcion').serialize(),
                function(resultado){
