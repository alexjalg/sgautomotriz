...
<div class="d-content-grilla" style="min-width: 660px;">
    ...
    <s:hidden name="idAmbUbi" id="idAmbUbi_h1" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-add').click(function(){
            ...
            var _varret = $('#nivBandeja_f').val()+'%'+href+'%'+$('#mtu_h1').val()+'%'+$('#mmo_h1').val()+'%'+$('#mop_h1').val()+'%'+$('#mni_h1').val()+'%'+$('#mod_h1').val()+'%'+$('#curPag_f').val()+'%'+$('#idAmbUbi_h1').val()+'|';
            $('#varReturn_f').val($('#varReturn_f').val()+_varret);
            
            $('#frm_princ').attr('action','<s:property value="baseURL" /><s:url namespace="ubicacionAmbiente" includeContext="false" action="adicionarUbicacionAmbiente" />');
            $('#frm_princ').submit();
        });
        
        $('#btn-edit').click(function() {
            post(
                '<s:property value="baseURL" /><s:url namespace="ubicacionAmbiente" includeContext="false" action="vrfSeleccionUbicacionAmbiente" />',
                $('#frm_princ').serialize(),
                function(resultado){
                    ...
                    else
                    {
                        ...
                        $('#frm_princ').attr('action','<s:property value="baseURL" /><s:url namespace="ubicacionAmbiente" includeContext="false" action="modificarUbicacionAmbiente" />');
                        $('#frm_princ').submit();
                    }
                },
                1
            ...
            post(
                ...
                function(resultado){
                    ...
                    else
                    {
                        $('#opcion_h1').val('C');
                        post(
                            '<s:property value="baseURL" /><s:url namespace="ubicacionAmbiente" includeContext="false" action="eliminarUbicacionAmbiente" />',
                            $('#frm_princ').serialize(),
                            function(resultado1)
                            {
