...
<div class="d-content-grilla" style="min-width: 660px;">
    ...
    <div class="d-grilla" style="overflow: hidden;">
        ...
        <div class="d-content-grilla-body">
            <table border="0" cellpadding="0" cellspacing="0" style="">
                <s:iterator value="listAdjuntosCliente">
                <tr>
                    <td style="width: 24px;">
                        <input type="radio" name="idAdjCli" id="rbt_idAdjCli" value="<s:property value="idAdjCli" />" class="select_rec" />
                    </td>
                    <td style="width: 100px; text-align: center;">
                        <s:property value="idAdjCli" />
                    </td>
                    <td style="">
                        <s:property value="desAdjCli" />
                    </td>
                    <td style="width: 140px; text-align: center;">
                        <s:property value="desTipAdj" />
                    </td>
                </tr>
                </s:iterator>
            </table>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-add').click(function(){
            ...
            var _varret = $('#nivBandeja_f').val()+'%'+href+'%'+$('#mtu_h1').val()+'%'+$('#mmo_h1').val()+'%'+$('#mop_h1').val()+'%'+$('#mni_h1').val()+'%'+$('#mod_h1').val()+'%'+$('#curPag_f').val()+'%'+$('#idCli_h1').val()+'|';
            $('#varReturn_f').val($('#varReturn_f').val()+_varret);
            
            $('#frm_princ').attr('action','<s:property value="baseURL" /><s:url namespace="adjuntosCliente" includeContext="false" action="adicionarAdjuntoCliente" />');
            $('#frm_princ').submit();
        });
        
        $('#btn-edit').click(function() {
            post(
                '<s:property value="baseURL" /><s:url namespace="adjuntosCliente" includeContext="false" action="vrfSeleccionAdjuntoCliente" />',
                $('#frm_princ').serialize(),
                function(resultado){
                    ...
                    else
                    {
                        ...
                        $('#frm_princ').attr('action','<s:property value="baseURL" /><s:url namespace="adjuntosCliente" includeContext="false" action="modificarAdjuntoCliente" />');
                        $('#frm_princ').submit();
                    }
                },
                1
            ...
            post(
                ...
                function(resultado){
                    ...
                    else
                    {
                        $('#opcion_h1').val('C');
                        post(
                            '<s:property value="baseURL" /><s:url namespace="adjuntosCliente" includeContext="false" action="eliminarAdjuntoCliente" />',
                            $('#frm_princ').serialize(),
                            function(resultado1)
                            {
