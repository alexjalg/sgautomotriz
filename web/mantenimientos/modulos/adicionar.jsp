...
<div class="d-content-form">
    <s:form id="frm_modulo" action='javascript:void(0)' theme="simple">
        <s:hidden name="idModu" />
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 50px;">Módulo<span class="required">*</span></td>
                <td>
                    <s:textfield name="desModu" cssClass="element-form" cssStyle="width:350px;" maxLength="40" />
                </td>
            </tr>
            <tr>
                <td></td>
