...
<form method="POST" id="frm_formapago_back" action="<s:property value="backURL" />">
    <!--s:hidden name="varReturn" id="varReturn_f" />!-->
    <s:property value="datosOblig" escape="false" />
</form>

<div class="d-content-form">
    <s:form id="frm_formapago" action='javascript:void(0)' theme="simple">
        <s:hidden name="idForPag" />
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 110px;">Forma de Pago<span class="required">*</span></td>
                <td>
                    <s:textfield name="desForPag" cssClass="element-form" cssStyle="width:350px;" maxLength="40" />
                </td>
            </tr>
            <tr>
                <td style="width: 80px;">Días Pago</td>
                <td>
                    <s:textfield name="numDiaPag" cssClass="element-form" cssStyle="width:40px;" maxLength="3" />
                </td>
            </tr>
            <tr>
                <td></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('a.back').click(function() {
            $('#frm_formapago_back').submit();
        });

        $('#btn_grabar').click(function() {
            post(
                    '<s:property value="formURL" />',
                    $('#frm_formapago').serialize(),
                    function(resultado) {
