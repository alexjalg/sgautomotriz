    ...
    <form id="frm_princ" method="POST" action="<s:property value="baseURL" /><s:property value="urlPaginacion" />">
        ...
        <div class="d-grilla" style="overflow: hidden;">
            ...
            <div class="d-content-grilla-body">
                <table border="0" cellpadding="0" cellspacing="0" style="">
                    <s:iterator value="listForPag">
                        <tr>
                            <td style="width: 24px;">
                                <input type="radio" name="idForPag" id="rbt_idForPag" value="<s:property value="idForPag" />" class="select_rec" />
                            </td>
                            <td style="width:60px; text-align: center;">
                                <s:property value="idForPag" />
                            </td>                            
...
<script type="text/javascript">
    ...
    <s:property value="jsPaginacion" escape="false" />
        ...
        $('#btn-add').click(function() {
            ...
            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="formaPago" includeContext="false" action="adicionarFormaPago" />');
            $('#frm_princ').submit();
        });

        $('#btn-edit').click(function() {
            post(
                    '<s:property value="baseURL" /><s:url namespace="formaPago" includeContext="false" action="vrfSeleccionFormaPago" />',
                    $('#frm_princ').serialize(),
                    function(resultado) {
                        ...
                        else
                        {
                            ...
                            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="formaPago" includeContext="false" action="modificarFormaPago" />');
                            $('#frm_princ').submit();
                        }
                    },
                    1
            ...
            post(
                    ...
                    function(resultado) {
                        ...
                        else
                        {
                            $('#opcion_h1').val('C');
                            post(
                                    '<s:property value="baseURL" /><s:url namespace="formaPago" includeContext="false" action="eliminarFormaPago" />',
                                    $('#frm_princ').serialize(),
                                    function(resultado1)
                                    {
                                                    ...
                                                    "Confirmar": function() {
                                                        ...
                                                        post(
                                                                ...
                                                                function(resultado2)
                                                                {
                                                                    ...
                                                                    {
                                                                        $('#DIVeliminar').dialog('close');
                                                                        $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="formaPago" includeContext="false" action="FormaPago" />');
                                                                        $('#frm_princ').submit();
                                                                    }
                                                                },
                                                                4
