...
<div class="d-content-grilla" style="min-width: 660px;">
    ...
    <div class="d-grilla" style="overflow: hidden;">
        ...
        <div class="d-content-grilla-body">
            <table border="0" cellpadding="0" cellspacing="0" style="">
                <s:iterator value="listModelos">
                <tr>
                    <td style="width: 24px;">
                        <input type="radio" name="idModMar" id="rbt_idModMar" value="<s:property value="idModMar" />" class="select_rec" />
                    </td>
                    <td style="width: 50px;">
                        <s:property value="idModMar" />
                    </td>
                    <td style="">
            ...
            post(
                ...
                function(resultado){
                    ...
                    else
                    {
                        $('#opcion_h1').val('C');
                        post(
                            '<s:property value="baseURL" /><s:url namespace="modelos" includeContext="false" action="eliminarModelo" />',
                            $('#frm_princ').serialize(),
                            function(resultado1)
                            {
