...
<form method="POST" id="frm_grupoCliente_back" action="<s:property value="backURL" />">
    <s:hidden name="varReturn" id="varReturn_f" />
</form>
        
<div class="d-content-form">
    <s:form id="frm_grupoCliente" action='javascript:void(0)' theme="simple">
        <s:hidden name="idGrpCli" />
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 120px;">Grupo de Cliente<span class="required">*</span></td>
                <td>
                    <s:textfield name="desGrpCli" cssClass="element-form" cssStyle="width:350px;" maxLength="40" />
                </td>
            </tr>
            <tr>
                <td></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('a.back').click(function(){
            $('#frm_grupoCliente_back').submit();
        });
        
        $('#btn_grabar').click(function(){
            post(
                '<s:property value="formURL" />',
                $('#frm_grupoCliente').serialize(),
                function(resultado){
