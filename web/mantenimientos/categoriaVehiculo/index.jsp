    ...
    <form id="frm_princ" method="POST" action="<s:property value="baseURL" /><s:property value="urlPaginacion" />">
        ...
        <div class="d-grilla" style="overflow: hidden;">
            ...
            <div class="d-content-grilla-body">
                <table border="0" cellpadding="0" cellspacing="0" style="">
                    <s:iterator value="listCatVeh">
                        <tr>
                            <td style="width: 24px;">
                                <input type="radio" name="idCatVeh" id="rbt_idCatVeh" value="<s:property value="idCatVeh" />" class="select_rec" />
                            </td>
                            <td style="width:60px; text-align: center;">
                                <s:property value="idCatVeh" />
                            </td>
                            <!--<td style="width:90px; text-align: center;">!-->
                            <td style="">
                                <s:property value="desCatVeh" />
                            </td>
                        </tr>
                    </s:iterator>
                </table>
...
<script type="text/javascript">
    ...
    <s:property value="jsPaginacion" escape="false" />
        ...
        $('#btn-add').click(function() {
            ...
            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="categoriaVehiculo" includeContext="false" action="adicionarCategoriaVehiculo" />');
            $('#frm_princ').submit();
        });

        $('#btn-edit').click(function() {
            post(
                    '<s:property value="baseURL" /><s:url namespace="categoriaVehiculo" includeContext="false" action="vrfSeleccionCategoriaVehiculo" />',
                    $('#frm_princ').serialize(),
                    function(resultado) {
                        ...
                        else
                        {
                            ...
                            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="categoriaVehiculo" includeContext="false" action="modificarCategoriaVehiculo" />');
                            $('#frm_princ').submit();
                        }
                    },
                    1
            ...
            post(
                    ...
                    function(resultado) {
                        ...
                        else
                        {
                            $('#opcion_h1').val('C');
                            post(
                                    '<s:property value="baseURL" /><s:url namespace="categoriaVehiculo" includeContext="false" action="eliminarCategoriaVehiculo" />',
                                    $('#frm_princ').serialize(),
                                    function(resultado1)
                                    {
                                                    ...
                                                    "Confirmar": function() {
                                                        ...
                                                        post(
                                                                ...
                                                                function(resultado2)
                                                                {
                                                                    ...
                                                                    {
                                                                        $('#DIVeliminar').dialog('close');
                                                                        $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="categoriaVehiculo" includeContext="false" action="CategoriaVehiculo" />');
                                                                        $('#frm_princ').submit();
                                                                    }
                                                                },
                                                                4
