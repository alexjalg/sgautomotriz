    ...
    <form id="frm_princ" method="POST" action="<s:property value="baseURL" /><s:property value="urlPaginacion" />">
        ...
        <div class="d-grilla" style="overflow: hidden;">
            ...
            <div class="d-content-grilla-body">
                <table border="0" cellpadding="0" cellspacing="0" style="">
                    <s:iterator value="listTipLoc">
                        <tr>
                            <td style="width: 24px;">
                                <input type="radio" name="idTipLoc" id="rbt_idTipLoc" value="<s:property value="idTipLoc" />" class="select_rec" />
                            </td>
                            <td style="width:60px; text-align: center;">
                                <s:property value="idTipLoc" />
                            </td>
                            <!--<td style="width:90px; text-align: center;">!-->
                            <td style="">
                                <s:property value="desTipLoc" />
                            </td>
                        </tr>
                    </s:iterator>
                </table>
...
<script type="text/javascript">
    ...
    <s:property value="jsPaginacion" escape="false" />
        ...
        $('#btn-add').click(function() {
            ...
            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="tipoLocal" includeContext="false" action="adicionarTipoLocal" />');
            $('#frm_princ').submit();
        });
            ...
            post(
                    ...
                    function(resultado) {
                        ...
                        else
                        {
                            ...
                            $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="tipoLocal" includeContext="false" action="modificarTipoLocal" />');
                            $('#frm_princ').submit();
                        }
                    },
                    1
                                                    ...
                                                    "Confirmar": function() {
                                                        ...
                                                        post(
                                                                ...
                                                                function(resultado2)
                                                                {
                                                                    ...
                                                                    {
                                                                        $('#DIVeliminar').dialog('close');
                                                                        $('#frm_princ').attr('action', '<s:property value="baseURL" /><s:url namespace="tipoLocal" includeContext="false" action="TipoLocal" />');
                                                                        $('#frm_princ').submit();
                                                                    }
                                                                },
                                                                4
