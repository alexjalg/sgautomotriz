...
<form method="POST" id="frm_colorinterior_back" action="<s:property value="backURL" />">
    <!--s:hidden name="varReturn" id="varReturn_f" />!-->
    <s:property value="datosOblig" escape="false" />
</form>

<div class="d-content-form">
    <s:form id="frm_colorinterior" action='javascript:void(0)' theme="simple">
        <table border="0" cellpadding="0" cellspacing="0" class="table-form">
            <tr>
                <td style="width: 70px;">Código<span class="required">*</span></td>
                <td>
                    <s:if test='%{idColInt == ""}'>
                        <s:textfield name="idColInt" cssClass="element-form" cssStyle="width:40px;" maxLength="3"/>
                    </s:if>
                    <s:else>
                        <s:textfield name="idColInt" cssClass="element-form" cssStyle="width:40px;" maxLength="3" disabled="true"/>
                        <s:hidden name="idColInt_h"></s:hidden>
                    </s:else>
                </td>
            </tr>
            <tr>
                <td style="width: 110px;">Color Interior<span class="required">*</span></td>
                <td>
                    <s:textfield name="desColInt" cssClass="element-form" cssStyle="width:350px;" maxLength="50" />
                </td>
            </tr>
            <tr>
                <td></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('a.back').click(function() {
            $('#frm_colorinterior_back').submit();
        });

        $('#btn_grabar').click(function() {
            post(
                    '<s:property value="formURL" />',
                    $('#frm_colorinterior').serialize(),
                    function(resultado) {
